...
class ${NAME}Adapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ${NAME}ViewHolder {
        ...
        return ${NAME}ViewHolder(binding, onItemClick, onDeleteItemClick)
    }
    ...
    class ${NAME}ViewHolder(
        ...
        fun bind(${NAME.toLowerCase()}: ${NAME}) {
            binding.textViewName.text = ${NAME.toLowerCase()}.firstName
            binding.textViewEmail.text = ${NAME.toLowerCase()}.email
            binding.textViewPhone.text = ${NAME.toLowerCase()}.phoneNumber
